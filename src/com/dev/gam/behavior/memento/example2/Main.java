package com.dev.gam.behavior.memento.example2;
...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    caretaker.addMemento(racheal.getEmpId(), "Saved at initial stage", rachealMemento);
    caretaker.addMemento(micheal.getEmpId(), "Saved at initial stage", michealMemento);
    ...
    rachealMemento = caretaker.getMemento(racheal.getEmpId(), "Saved at initial stage");
